...
In this version instead of using display or application interface, the system provides immediate feedback through LEDs and the Serial Monitor. **This version shows the initial implementation** of the project and can be expanded in the future with features such as display, alert system or IoT connectivity.

---
### Features 
1) Real-time temperature measurement using the LM35 sensor.
2) Analog to digital conversion.
3)  voltage to temperature calculation.
4) Visual feedback through the LEDs.
...
Developed by Niloofar Rohibakhsh
